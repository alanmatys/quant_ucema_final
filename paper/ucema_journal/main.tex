...
Of the 87 symbols ever included in the PIT universe across 100
monthly snapshots, 38 were dropped during the window before
2026-05-18 (Figure~\ref{fig:pit_evol}). The MACI 2025 dataset
contained only 50 currently-trading symbols --- by construction it
could not include LUNA, FTT, ANC, MIR, SRM, or the other crises this
work explicitly captures. We treat liquidation of an exiting position
at 2$\times$ normal slippage cost (Spec 03 \S2.4).
...
\toprule
Strategy & Arith. Sharpe & Total Return & Max DD & N\_eff & Turnover\\
\midrule
MVP                  & 0.950 & +2035\% & --81\% &  5.5 & 0.405\\
HODL\_BTC            & 0.867 & +1003\% & --77\% &  1.0 & ---\\
MaxDiv               & 0.793 &  +627\% & --92\% &  9.9 & 0.459\\
\textbf{HRP\_ShrunkCov} & \textbf{0.748} & +436\% & --84\% & 27.2 & 0.308\\
HRP\_TailDep         & 0.733 &  +396\% & --85\% & 30.1 & 0.317\\
HRP (baseline)       & 0.732 &  +393\% & --85\% & 28.4 & 0.314\\
HRP\_TailDepShrunk   & 0.729 &  +384\% & --85\% & 31.7 & 0.308\\
HRP\_VolStd          & 0.728 &  +381\% & --85\% & 30.1 & 0.307\\
HRP\_Detoned         & 0.701 &  +321\% & --85\% & 35.0 & 0.210\\
HRP\_PartialCorr     & 0.696 &  +311\% & --85\% & 34.8 & 0.140\\
IVP                  & 0.696 &  +311\% & --85\% & 34.8 & 0.140\\
ERC                  & 0.686 &  +277\% & --86\% & 46.6 & 0.131\\
\midrule
\multicolumn{6}{l}{\emph{Momentum (Scenario B)}}\\
MOM\_HRP\_Detoned    & 0.305 &  +351\% & --88\% & 12.0 & 1.420\\
CS\_MOM\_vol21       & 0.233 &  +228\% & --89\% & 13.0 & 1.416\\
CS\_MOM\_eq21        & 0.216 &  +210\% & --90\% & 14.4 & 1.399\\
RM\_MOM              & 0.216 &  +210\% & --90\% & 14.4 & 1.399\\
TS\_MOM\_abs         & 0.181 &  +157\% & --91\% & 14.6 & 1.405\\
MOM\_HRP             & 0.136 &  +106\% & --93\% & 11.5 & 1.444\\
TS\_MOM\_ma          & 0.108 &   +80\% & --93\% & 11.5 & 1.508\\
\bottomrule
\end{tabular}
\end{table}
...
\paragraph{HRP family bunches.} All seven HRP variants lie within
0.05 Sharpe of each other (0.696--0.748). HRP\_ShrunkCov is
marginally the best HRP-family member, but the improvement over
baseline HRP (+0.016 Sharpe) is small and, per
\S\ref{sec:results-inference} below, not statistically significant.
...
\paragraph{Pairwise LW Sharpe differences vs.\ HRP.} \emph{None} of the
11 candidates reach $p < 0.05$. HRP\_ShrunkCov's improvement is the
closest at $\Delta\text{Sharpe} = +0.016$ ($p=0.275$). MVP beats HRP by
0.217 ($p=0.20$), HODL\_BTC by 0.135 ($p=0.56$).

\paragraph{Hansen SPA.} Across all 11 candidates vs.\ HRP,
$p_{\text{consistent}} = 0.526$, $p_{\text{upper}} = 0.870$
...
multiple-testing of 11 candidates}, even with 6.3 years of
monthly-rebalanced data.
