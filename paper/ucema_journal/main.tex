...
measurable on top of it. Changing the clustering step
...
more moderate concentration of CRISP and NCO\_CRISP ($N\approx7$--$9$)
places their detectable-edge threshold between NCO's $0.42$ and the
tightly-coupled HRP family's $0.04$--$0.12$ band, low enough that their
$\approx+0.24$ edges \emph{do} clear pairwise significance while MVP's
larger but noisier edge does not.
...
HRP?''; the SPA asks ``does \emph{the best of 25 searched strategies}
beat HRP, given that we searched 25?'', and inflates the critical
