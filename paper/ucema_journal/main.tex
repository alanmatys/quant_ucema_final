...
broaden the comparison to 22 portfolio strategies: twelve HRP-family
...
NCO's economically large edge is statistically invisible. Tilting NCO
...
\item \textbf{HRP variants, embedding variants, and nested-clustering
      ...
      \citep{ciciretti2024nrp} serve as risk-based comparators.
...
Table~\ref{tab:scenarioB} reports the 22-strategy comparison under
monthly rebalancing with conservative CEX costs over 2020-02
through 2026-05-18 (76 rebalances, 2{,}297 daily out-of-sample
...
paper's sharpest single result: \emph{changing the clustering step does
nothing; changing the allocation step is what moves performance --- in
either direction.}
...
\textbf{(2) NCO's edge is not a pure bull-market artefact.} NCO loses
...
implication is concrete: time spent engineering a better distance
metric or a learned embedding is, on this evidence, time wasted; the
allocation objective is where the degrees of freedom that matter live.
...
power floor, leaves NCO's economically meaningful edge an open
...
into BTC. This is the uncomfortable finding the paper must not soften:
...
We evaluated 22 portfolio strategies --- twelve HRP-family variants
...
learned embedding builds the dendrogram --- does not matter: across a
