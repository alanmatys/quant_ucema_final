...
embeddings neither help nor hurt. Section~\ref{sec:results-sweeps}
stress-tests this conclusion with an exhaustive hyperparameter search
and multi-channel embedding extensions; it survives intact.
...
\begin{table}[H]
  \centering
  \small
  \caption{Best cell from each Phase~8 hyperparameter sweep. $\Delta$ is
