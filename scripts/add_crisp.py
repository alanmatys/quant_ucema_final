...
CRISP (Correlation-Regularised Iterative Shrinkage Portfolio; Wuebben
2026) is added as a 24th comparator. Rather than re-run every strategy,
...
from src.portfolio_maker import HRP, CRISP
